...
# actor-critic
parser.add_argument("--actor_layer1", default=, type=int, help="Actor network layer1")
parser.add_argument("--actor_layer2", default=, type=int, help="Actor network layer2")
parser.add_argument("--actor_layer", default=, type=int, help="Actor network layer6")

parser.add_argument("--critic_layer1", default=, type=int, help="Critic network layer1")
parser.add_argument("--critic_layer2", default=, type=int, help="Critic network layer2")
parser.add_argument("--critic_layer", default=, type=int, help="Critic network layer6")

parser.add_argument("--temp_layer1", default=, type=int, help="Actor network layer1")
parser.add_argument("--temp_layer2", default=, type=int, help="Actor network layer2")
parser.add_argument("--temp_layer", default=, type=int, help="Actor network layer6")

parser.add_argument("--action_emb_layer", default=, type=int, help="Action emb layer")
parser.add_argument("--state_emb_layer", default=, type=int, help="State emb layer")
...
parser.add_argument("--buffer_size", default=, type=int, help="Buffer_size")
parser.add_argument("--sampling_size", default=, type=int, help="Sampling_size")
...
parser.add_argument("--soft_update_ratio", default=, type=float, help="Soft update ratio")
parser.add_argument("--target_n", default=, type=int, help="Target network freeze N")
parser.add_argument("--target_soft_update_ratio", default=, type=float, help="Target soft update ratio")
...
parser.add_argument("--w_clamp_v", default=, type=float, help="Weight clamp value")
parser.add_argument("--g_clamp", default=False, type=bool, help="Grandient clamp")
parser.add_argument("--g_clamp_v", default=, type=float, help="Grandient clamp value")
